...
class Classifier:
    ...
    def set_score(self, scores):
        ...
        self.scores = scores
        # self.fit_time = mean(scores['fit_time'])  # avg time for fitting all cv splits
        # self.score_time = mean(scores['score_time'])  # avg time for scoring the estimator on the test set
    ...
    def export_model(self, model_dir=None, pre_fix="") -> None:
        ...
        Example
        -------
        >>> export_model(sub_dir='/mlcq', prefix='baseline') 
        """
        
        file_path = '../models'+model_dir
